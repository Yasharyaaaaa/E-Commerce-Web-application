...
const Categories = () => {
  ...
  // Sync URL param → filter without a separate effect (derive directly)
  // We initialise from urlCategory above; subsequent URL changes are handled
  // by the handleCategorySelect callback which updates both state and URL.
